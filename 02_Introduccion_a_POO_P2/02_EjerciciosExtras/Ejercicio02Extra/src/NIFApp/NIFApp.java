...
public class NIFApp {
    public static void main(String[] args) {
        ...
        // Creamos un objeto de la clase servicio para poder utilizar sus metodos
        NIFServicios objetoDeServicio = new NIFServicios();

        // Creamos un objeto de tipo NIFClass para luego rellenar sus atributos con el 
        // metodo 'crearNuevoNIF' de la clase 'NIFServicios'.
        NIFClass codigoNIF1;

        // Asignamos los parametros de 'codigoNIF1' a traves de la utilizacion del 'objetoDeServicio'
        codigoNIF1 = objetoDeServicio.crearNIF();

        // Calculamos el 'digitoVerificador' del documento ingresado en 'codigoNIF1'
        objetoDeServicio.calcularDigitoVerificador(codigoNIF1);

        //Imprimimos el 'codigoNIF1'
        objetoDeServicio.mostrarNIF(codigoNIF1);
